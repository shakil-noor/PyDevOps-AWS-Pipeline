...
output "ssh_connection_string_for_ec2" {
  value = format("%s%s", "ssh -i /Users/sakilnur/.ssh/pydevops_jenkins ubuntu@", aws_instance.jenkins_ec2_instance.public_ip)
}

output "jenkins_ec2_instance" {
